...
//   return (
//     <div className="absolute mt-auto flex flex-flexbox justify-end text-left">
//       {coordinators && (
//         <div className="coordinators ml-0">
//           <h4 className="font-semibold text-lg">Coordinators:</h4>
//           <ul className="list-disc list-inside text-sm text-black pl-4">
...
//         <div className="absolute bottom-0 left-80 w-[234px] h-[65px] bg-[#d9d9d9] rounded-[40px] flex items-center justify-center"> {/* Rectangle */}
...
//           </div>
//         </div>
//         <div className="absolute top-[38px] left-80 w-60 h-[233px] rounded-full bg-[#c4c4c4]" /> {/* Circle */}
//         <div className="absolute top-0 left-0 transform rotate-[0.25deg] [font-family:'Inter-SemiBold',Helvetica] font-semibold text-black text-[50px]">
//           {head}
//         </div>
//       </div>
//     </div>
